<%@ page import="com.quizgame.service.GameService" %>
...
<div class="w3-container w3-blue-grey w3-opacity w3-left-align">
    <form action="del" method="post">
        <button class="w3-btn w3-opacity-min w3-animate-bottom w3-gray w3-round-large" name="button" value="all"
                type="submit">Delete all users
        </button>
    </form>
</div>
<div class="w3-container w3-grayscale w3-left-align">
    <form action="del" method="post">
        ...
        <input class="w3-input w3-animate-input w3-border w3-round-large" type="text" name="name" id="name"
               required><br>
        <label for="nickName">User nickname</label>
        <input class="w3-input w3-animate-input w3-border w3-round-large" type="text" name="nickName" id="nickName"
               required><br>
        <label for="id">User Id</label>
        <input class="w3-input w3-animate-input w3-border w3-round-large" type="number" name="id" id="id" required><br>
        <button class="w3-btn w3-animate-bottom w3-gray w3-round-large" name="button" value="one" type="submit">Delete
            user
        </button>
        <br>
    </form>
