<%@ page import="com.quizgame.service.PasswordSaver" %><%--
...
<div class="w3-selection w3-light-grey w3-padding">
    <form action="passw" method="post">
        ...
        <input class="w3-hover-border-pale-green w3-round-large" type="password" name="pass" id="pass" required
               pattern="^\d+$" size="5"><br>
...
<div class="w3-selection w3-gray w3-padding">
    <button class="w3-btn w3-blue-gray w3-round-large w3-margin-bottom" type="button"
            onclick="window.location='/admin'">Change password
    </button>
</div>
